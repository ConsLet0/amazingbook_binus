                      ...
                      <div class="card">
                        ...
                        <tbody>
                            ...
                            <tr>
                                  ...
                                  <td>
                                    <span class="ps-2">{{ $data->first_name }}</span>
                                  </td>
                                ...
                                <td><a href="{{ url('/updateroles', $data->id) }}"><button type="button" class="btn btn-outline-light btn-md">Update Role</button></a></td>
                                <td><a href="{{ url('/deleteuser', $data->id) }}"><button type="button" class="btn btn-outline-danger btn-md">Delete</button></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                            </table>
