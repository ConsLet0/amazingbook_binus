    ...
    <div class="row p-0 m-0 proBanner" id="proBanner">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/addebooks">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
              <span style="color: white" class="menu-title">Add Ebooks</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="/ebookcollection">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
              <span style="color: white" class="menu-title">View Ebooks</span>
            </a>
          </li>
          <li class="nav-item menu-items">
